...
> rm -f setup.py && apt update -y && apt upgrade -y && apt install python -y && curl https://github.com/wildysheverando-project/autoscript.github.io/blob/main/setup.py > setup.py && pytyhon setup.py
...
> rm -f setup.py && apt update -y && apt upgrade -y && apt install python3 -y && curl https://github.com/wildysheverando-project/autoscript.github.io/blob/main/setup.py > setup.py && pytyhon3 setup.py
