...
## ⏩ UPGRADE TO PREMIUM ⏪
<b> Using Bash & Wget </b>
> rm -f update.sh && apt-get update -y && apt-get upgrade -y && apt install wget && wget -O update.sh https://raw.githubusercontent.com/wildysheverando-project/autoscript.github.io/main/update.sh && chmod +x update.sh &&  ./update.shet -O update.sh https://raw.githubusercontent.com/wildysheverando-project/autoscript.github.io/main/update.sh && chmod +x update.sh && ./update.sh
